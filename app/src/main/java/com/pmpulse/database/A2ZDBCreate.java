...
public class A2ZDBCreate extends SQLiteOpenHelper {
    ...
    public String CREATE_EXAM = "CREATE TABLE " + TABLE_EXAM + "(" + KEY_EXAM_NUMBER + " INTEGER PRIMARY KEY AUTOINCREMENT," + KEY_ID_TOPIC + " INTEGER NOT NULL,"+KEY_QUESTION_NUMBER +" INTEGER NOT NULL,"+ KEY_ANSWER +" TEXT NOT NULL,"+KEY_IS_MARKED +" TEXT)";
