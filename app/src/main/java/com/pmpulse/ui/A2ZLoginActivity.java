...
public class A2ZLoginActivity extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_a2zlogin);
            TypefaceUtil.overrideFont(A2ZLoginActivity.this);
        ...
        private void initialiseView() {
            ...
            mLoginFormView = findViewById(R.id.login_form_a2z);
            mProgressView = findViewById(R.id.login_progress_a2z);

            A2ZUser a2ZUser = new A2ZUser().getCreds(getApplicationContext());
            mEmailView.setText(a2ZUser.getUserName());
            mPasswordView.setText(a2ZUser.getUserPassword());
        ...
        private void attemptLogin() {
            ...
            if (isEmailValid(email))
                if (isPasswordValid(password, mPasswordView)) {
                    if (new ConnectionMaker().isConnected(A2ZLoginActivity.this)) {
                      // TODO Phase:2 web service request
        ...
        private void performDBOperation() {
            //TODO phase2 logic for any db operation
...
*/
        ...
        public class UserLoginTask extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(final String response) {
                ...
                //store creds in Shared Preferences
                new A2ZUser().storeCreds(mEmail, mPassword, getApplicationContext());
                Intent intent = new Intent(A2ZLoginActivity.this, A2ZMainActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
               //TODO: actual logic for page handling and transfer
                // mProgressView.setVisibility(View.GONE);
              ...
              /*  if (response == null) {
                    ...
                    if (status.equals(Parser.success)) {
                        ...
                        KeyValues.udid = udid;
                        //navigate to main
                        Intent intent = new Intent(A2ZLoginActivity.this, MainActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(intent);
                        finish();
                    } else {
        ...
        public void onBackPressed() {
            super.onBackPressed();
            Intent intent = new Intent(A2ZLoginActivity.this, FeaturesActivity.class);
        ...
        private void showAlert(final String message) {
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(A2ZLoginActivity.this);
